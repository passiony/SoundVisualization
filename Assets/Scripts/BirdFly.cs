...
public class BirdFly : MonoBehaviour
{
    ...
    private MaxFrenquencyListener listener;
    private Dictionary<int, AnimalInfo> m_AnimalDic;
    private int[] lastArgs = new int[]{0,0};

    void Awake()
    {
        listener = gameObject.GetComponent<MaxFrenquencyListener>();
        listener.MaxFrenquencyEvent.AddListener(OnFrenquencyEvent);//监听频率变化事件
